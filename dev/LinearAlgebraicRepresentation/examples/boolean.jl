...
wall = Lar.svg2lar("dev/LinearAlgebraicRepresentation/test/svg/assembly/wall.svg", flag=false)
openings = Lar.svg2lar("dev/LinearAlgebraicRepresentation/test/svg/assembly/openings.svg", flag=false)
rectangle = Lar.svg2lar("dev/LinearAlgebraicRepresentation/test/svg/assembly/rectangle.svg", flag=false)
box = Lar.svg2lar("dev/LinearAlgebraicRepresentation/test/svg/assembly/box.svg", flag=false)
